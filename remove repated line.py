# Set the file paths
'''''
دي بتستخدمه ونت بتعمل ريكون ونت بتجمع صب دومين من كذا اداه فعلشان ميبقاش في حاجه مكرره
'''''
input_file_path = r'H:\BugBounty Progrmes\tragets\scripts\3.txt'
output_file_path = r'H:\BugBounty Progrmes\tragets\scripts\3.txt'
